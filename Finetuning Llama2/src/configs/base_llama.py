...
# Output directory
output_dir = "/nlp/data/kashyap/Dissertation/paralleLM/output_dir/llama2/dementia_" + llama_size 
resume_from_checkpoint = None
metrics = ['bleu']

raw_data = "/nlp/data/kashyap/Dissertation/paralleLM/dementia/"
...
preprocessing_kwargs = {
    ...
    "drop_tables": False,
    "column_dict": {"inputs": ["context","question"],"target":"answer"},
    "input_template": "[INST] {} {} [/INST]",
    "target_template": "{}",
    "concat_input_output": True,
    "keep_columns": ["hadm_id","index","inputs","target","question"]
}
 
 
tokenization_kwargs = {
    "tokenizer_name": '/scratch/kashyap/models/Llama-2-' + llama_size + '-chat-hf', 
...
# Model Arguments
module_kwargs = {
    "model_name": '/scratch/kashyap/models/Llama-2-' + llama_size + '-chat-hf',
    "optimizer": 'AdamW',
